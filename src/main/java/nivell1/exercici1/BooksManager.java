...
public class BooksManager {
    ...
    static void addBook(String title, String author,ArrayList<Book> booksArrayList){
        ...
        if (booksArrayList.isEmpty()){
            ...
            IO.println("The book " + newBook + " has been added.");
            ...
            for(Book book : booksArrayList){
                ...
                if(title.equals(book.getTitle())){
                    ...
                    IO.println("This book already exists, duplicate books are not allowed.");
                    return;
                }
            }
    ...
    static void deleteBookByTitle(String title, ArrayList<Book> booksArrayList){
        ...
        if(titleExists){
            IO.println("Book deleted: " + title);
        }else{
            IO.println(String.format("The book %s does not exists in this library.", title));
        }
